...
This directory contains a fully offline static explanation for the KarmaDock seminar project.
...
their repository locations are [here](https://github.com/volkamerlab/DLDockingBenchSeminar/tree/karmadock).
